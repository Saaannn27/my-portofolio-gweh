...
export const PILLARS = [
  ...
  { id: 'data', number: '03', title: 'DATA ANALYST', code: '03 / DATA', description: 'ETL pipelines, machine learning algorithms, unsupervised clustering, and interactive visual data dashboards.' },
